...
export class Tab1Page {
  ...
  public lineChartColors: Array<any> = [
    { // grey
      backgroundColor: 'rgba(112,159,177,0.2)',
  ...
  public lineChartData: Array<any> = [
    { data: [35, 52, 24, 51, 21, 66, 23], label: 'Series A' },
    { data: [21, 61, 90, 22, 44, 34, 66], label: 'Series B' },
    { data: [13, 45, 11, 4, 30, 64, 33], label: 'Series C' }
  ];
